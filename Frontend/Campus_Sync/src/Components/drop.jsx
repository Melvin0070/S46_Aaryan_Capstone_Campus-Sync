...
function Drop() {
  ...
  const handleUpload = async (e) => {
    ...
    try {
      const response = await axios.post(import.meta.env.VITE_SERVER_URL + "/drops/upload", formData, {
  ...
  const handleFileDelete = async (fileId) => {
    try {
      await axios.delete(import.meta.env.VITE_SERVER_URL + `/drops/files/${fileId}`, {
          ...
          <>
            ...
            <div className="carousel-content">
              <div className="file-details">
                <strong>{files[currentIndex].topic}</strong><br />
